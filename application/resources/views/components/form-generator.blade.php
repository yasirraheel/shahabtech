    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang('Form Options')</h5>
            ...
            <form class="{{ $formClassName ?? 'generate-form' }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="form_type" class="form-control form-select" required>
                    ...
                    <div class="form-group">
                        ...
                        <select name="is_required" class="form-control form-select" required>
                            <option value="">@lang('Select One')</option>

                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control iconPicker icon" autocomplete="off" name="icon" placeholder="@lang('Icon')" required>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea class="trumEdit" name="description" placeholder="@lang('Description')" id="new_pass"  cols="40" rows="10"></textarea>
                            </div>
                        </div>

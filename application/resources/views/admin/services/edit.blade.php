                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input step="any" type="number" name="price" id="price" value="{{$service->price}}" class="form-control" placeholder="@lang('Price')" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-text  input-group-addon" data-icon="las la-home" role="iconpicker">@php echo $service->icon @endphp</span>
                                </div>
                            </div>
                        </div>

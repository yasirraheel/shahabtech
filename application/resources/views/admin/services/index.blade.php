                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two custom-data-table">
                            ...
                            <tbody id="items_table__body">
                                @include('admin.components.tables.service_data')
                            </tbody>
                        </table>
                    </div>
                </div>
...
@push('breadcrumb-plugins')
    <a class="btn btn--primary add__btn" href="{{ route('admin.service.create') }}"><i class="fa-solid fa-plus"></i> @lang('Add New')</a>
@endpush
...
@push('script')
    <script>
        (function ($) {
            ...
            let baseUrl = `{{ route('admin.service.index', ':status') }}`;

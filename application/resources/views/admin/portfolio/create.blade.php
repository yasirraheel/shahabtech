                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" value="{{old('title')}}" class="form-control" placeholder="@lang('Title')" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="sub_title" id="sub_title" value="{{old('Sub_title')}}" class="form-control " placeholder="@lang('Sub Title')" required>
                            </div>
                        </div>

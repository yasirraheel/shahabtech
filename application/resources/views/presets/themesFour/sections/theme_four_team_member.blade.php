@php
    $teamContent =  getContent('theme_four_team_member.content',true);
...
<section class="team py-80">
    <div class="container">
        <div class="title">
            <h6>{{__($teamContent?->data_values?->top_heading ?? '')}}</h6>
            <h4>{{__($teamContent?->data_values?->heading ?? '')}}</h4>
            <p>{{__($teamContent?->data_values?->subheading ?? '')}}</p>
        </div>

            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-item">
                    ...
                    <div class="blog-item__content">
                        ...
                        <a href="{{ route('blog.details', ['slug' => slug($item->data_values->title), 'id' => $item->id])}}" class="btn--simple">{{__($item?->data_values?->blog_btn ?? 'Read More')}}<span class="btn--simple__icon"><i class="fas fa-arrow-right"></i></span></a>
                    </div>
                </div>
            </div>
            @endforeach

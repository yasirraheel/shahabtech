                ...
                <div class="testimonails-card">
                    <div class="testimonial-item">
                        ...
                        <div class="testimonial-item__thumb">
                            <img src="{{getImage(getFilePath('testimonial').'/'. $item?->data_values?->testimonial_image ?? '' )}}" alt="@lang('testimonial')">
                        </div>
                        ...
                        <div class="testimonial-item__content">
                            ...
                            <div class="testimonial-item__rating">
                                <ul class="rating-list">
                                    <li class="rating-list__item">@php echo showRatings($item?->data_values?->star_count); @endphp</li>
                                </ul>
                            </div>
                        </div>
                    </div>

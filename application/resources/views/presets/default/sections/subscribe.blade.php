        ...
        <div class="row  gy-4 justify-content-center align-items-center">
            <div class="col-lg-7">
                <div class="subscribe-wrap">
                    <div class="section-heading">
                        ...
                        <h2 class="section-heading__title">{{__($subscribe?->data_values?->heading ?? '')}}</h2>
            ...
            <div class="col-lg-5">
                <div class="subscribe-right">
                    <div class="thumb">
                        <img src="{{getImage(getFilePath('subscribe').'/'. $subscribe?->data_values?->subscribe_image ?? '')}}" alt="@lang('image')">
                    </div>
                </div>
            </div>
        </div>

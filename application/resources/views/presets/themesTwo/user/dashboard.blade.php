              ...
              <a class="d-block" href="{{route('plans')}}">
                <div class="dashboard-card">
                    ...
                    <div class="dashboard-card__content">
                        ...
                        <h4 class="dashboard-card__amount">{{$general->cur_sym}} {{showAmount($subscribe?->plan?->price ?? 0)}}</h4>
                ...
                <a class="d-block" href="{{route('user.orders')}}">
                    <div class="dashboard-card ">
                        ...
                        <div class="dashboard-card__content">
                            ...
                            <h4 class="dashboard-card__amount">{{$totalOrders}}</h4>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a class="d-block" href="javascript:void(0)">
                    <div class="dashboard-card ">
                        ...
                        <div class="dashboard-card__content">
                            ...
                            <h4 class="dashboard-card__amount">{{$general->cur_sym}} {{showAmount(auth()->user()->balance)}}</h4>
                        </div>
                    </div>
                </a>
            </div>
...
<script>
    ...
    (function () {
        ...
        name: '@lang("Deposits")',
        type: 'area',
        data: <?php echo json_encode($depositsChart['values']) ?>
    }],
    fill: {
        opacity: [0.85, 1],
                },
    labels: <?php echo json_encode($depositsChart['labels']) ?>,
    markers: {
        size: 0
    },
    xaxis: {
